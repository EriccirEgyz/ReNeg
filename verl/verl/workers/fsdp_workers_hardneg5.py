...
class RewardModelWorker(Worker, DistProfilerExtension):
    ...
    def _forward_micro_batch(self, micro_batch):
        ...
        with torch.no_grad(), torch.autocast(device_type=device_name, dtype=torch.bfloat16):
            ...
            url = "http://10.158.45.229:30000" # server ip需要调整！！！
            ...
            def judge_one(i):
                ...
                prompt = instruction_p6 + raw_query + '\n# Positive document:\n' + raw_positive + '\n# Generated document:\n' + raw_hardneg
            ...
            rm_scores[neg_sim >= pos_sim] = -1
            mask_ge = neg_sim >= pos_sim
            num_ge = mask_ge.sum().item()
            print(f"<neg_sim >= pos_sim number> {num_ge}")
